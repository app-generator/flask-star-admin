...
[Admin dashboard](https://appseed.us/admin-dashboards) generated by AppSeed in **[Flask](https://appseed.us/admin-dashboards/flask)** Framework. [Star Admin](https://appseed.us/admin-dashboards/flask-dashboard-staradmin-pro) is a beautifully designed admin template featuring a fine selection of useful Bootstrap components and elements. The pre-built pages of the templates are intuitive and very well-designed.
...
---
[Star Admin Flask](https://appseed.us/admin-dashboards/flask-star-admin) - Provided by **AppSeed [App Generator](https://appseed.us/app-generator)**.
