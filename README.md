# [Star Admin](https://appseed.us/generator/star-admin/) Flask

Open-source **Flask Dashboard** generated by `AppSeed` op top of an iconic `Bootstrap 5` Design. For newcomers, **[Star Admin](https://appseed.us/generator/star-admin/)** is a beautifully designed admin template featuring a fine selection of useful Bootstrap components and elements. The pre-built pages of the templates are intuitive and very well-designed.
...
- Build ID: `92d7ce9b-497d-4ad9-94b6-c1e7e2a8d2fc`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/92d7ce9b-497d-4ad9-94b6-c1e7e2a8d2fc.git
$ cd 92d7ce9b-497d-4ad9-94b6-c1e7e2a8d2fc
```
...
---
[Star Admin](https://appseed.us/generator/star-admin/) Flask - Open-source starter generated by **[AppSeed Generator](https://appseed.us/generator/)**.
